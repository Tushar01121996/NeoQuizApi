...
{
    public class UpdateUserQuizCommandRequestHandler : IRequestHandler<CreateUserQuizCommand, Response<UserQuizDTO>>
    {
        private readonly IUserQuizRepository _repository;
        private readonly IMapper _mapper;

        public UpdateUserQuizCommandRequestHandler(IUserQuizRepository repository, IMapper mapper)
        {
